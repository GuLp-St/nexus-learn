...
const COSMETICS: Cosmetic[] = [
  ...
  { id: "avatar-ai", category: "avatar", rarity: "unique", price: 5000, name: "AI Generated", description: "A unique avatar generated by Cloudflare AI", config: { type: "custom", source: "ai" } },
...
export function resolveAvatarStyle(cosmeticId: string | undefined): AvatarStyle {
  ...
  const validStyles: AvatarStyle[] = [
    ...
    "big-smile", "avataaars", "lorelei", "micah", "ai", "unsplash", "upload"
  ]
